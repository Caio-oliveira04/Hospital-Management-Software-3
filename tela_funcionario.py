...
"background-color: rgba(0, 0, 0, 0);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600;\">Escala de servidores </span></p></body></html>"))
        ...
        self.label_5.setText(_translate("Form", "Digite o nome de um servidor para adicionar "))
        ...
        self.lineEdit_remedio_padicionar.setPlaceholderText(_translate("Form", "Qntd / nome do remédio"))
        ...
        self.label_text_remed.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600;\">Estoque de remédios</span></p></body></html>"))

...
class UI_LoginMed(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QtCore.QRect(276, 130, 301, 591))
...
"")
        ...
        self.label_text_login_2 = QtWidgets.QLabel(self.widget)
        self.label_text_login_2.setGeometry(QtCore.QRect(30, 70, 401, 141))
        font = QtGui.QFont()
        ...
        self.label_text_login_2.setFont(font)
        self.label_text_login_2.setFocusPolicy(QtCore.Qt.NoFocus)
        self.label_text_login_2.setWhatsThis("")
        self.label_text_login_2.setStyleSheet("QLabel {\n"
"    color:rgb(26, 40, 49);\n"
"\n"
"    letter-spacing: 1.5px; /* Ajuste o valor conforme necessário */\n"
"}\n"
"")
        self.label_text_login_2.setObjectName("label_text_login_2")
        self.line = QtWidgets.QFrame(self.widget)
        self.line.setGeometry(QtCore.QRect(33, 160, 118, 3))
        self.line.setStyleSheet("background-color: rgb(26, 40, 49);\n"
"")
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.label_text_login_3 = QtWidgets.QLabel(self.widget)
        self.label_text_login_3.setGeometry(QtCore.QRect(30, 180, 401, 141))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(23)
        font.setBold(True)
        ...
        font.setWeight(75)
        font.setKerning(False)
        self.label_text_login_3.setFont(font)
        self.label_text_login_3.setFocusPolicy(QtCore.Qt.NoFocus)
        self.label_text_login_3.setWhatsThis("")
        self.label_text_login_3.setStyleSheet("QLabel {\n"
"    color:rgb(26, 40, 49);\n"
"    letter-spacing: 1.5px; /* Ajuste o valor conforme necessário */\n"
"}\n"
"")
        self.label_text_login_3.setObjectName("label_text_login_3")
        self.widget_2 = QtWidgets.QWidget(Form)
        self.widget_2.setGeometry(QtCore.QRect(576, 150, 531, 541))
        self.widget_2.setStyleSheet("background-color: rgba(0, 0, 0,0);\n"
"")
        self.widget_2.setObjectName("widget_2")
        self.label_fundo_cadastro = QtWidgets.QLabel(self.widget_2)
        self.label_fundo_cadastro.setGeometry(QtCore.QRect(0, 0, 371, 541))
...
"border-bottom-right-radius:50px;")
        ...
        self.label_nome_git.setGeometry(QtCore.QRect(110, 480, 201, 41))
        font = QtGui.QFont()
        ...
        self.label_text_login = QtWidgets.QLabel(self.widget_2)
        self.label_text_login.setGeometry(QtCore.QRect(-10, 60, 401, 141))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(23)
        font.setBold(True)
...
"")
        ...
        self.lineEdit_senha_login = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_senha_login.setGeometry(QtCore.QRect(100, 300, 211, 42))
        font = QtGui.QFont()
...
"    border: 1px solid rgba(233, 226, 226, 0.35);")
        ...
        self.label_imagem_cadeado_login = QtWidgets.QLabel(self.widget_2)
        self.label_imagem_cadeado_login.setGeometry(QtCore.QRect(58, 303, 37, 35))
        ...
        self.lineEdit_email_login = QtWidgets.QLineEdit(self.widget_2)
        self.lineEdit_email_login.setGeometry(QtCore.QRect(100, 220, 211, 41))
        font = QtGui.QFont()
        font.setFamily("Swis721 LtEx BT")
        font.setPointSize(8)
        font.setBold(False)
...
"    border: 1px solid rgba(233, 226, 226, 0.35);")
        ...
        self.label_4.setGeometry(QtCore.QRect(50, 220, 51, 41))
...
"    border: 1px solid rgba(233, 226, 226, 0.35);")
        ...
        self.label_imagem_email = QtWidgets.QLabel(self.widget_2)
        self.label_imagem_email.setGeometry(QtCore.QRect(58, 226, 34, 31))
        self.label_imagem_email.setText("")
        self.label_imagem_email.setPixmap(QtGui.QPixmap(":/imagens/icons8-médico-50.png"))
        self.label_imagem_email.setScaledContents(True)
        self.label_imagem_email.setObjectName("label_imagem_email")
        self.label_5 = QtWidgets.QLabel(self.widget_2)
        self.label_5.setGeometry(QtCore.QRect(50, 300, 51, 42))
...
"    border: 1px solid rgba(233, 226, 226, 0.35);")
        ...
        self.pushButton_login.setGeometry(QtCore.QRect(80, 380, 181, 41))
        font = QtGui.QFont()
...
"")
        ...
        self.label_imagem_git = QtWidgets.QLabel(self.widget_2)
        self.label_imagem_git.setGeometry(QtCore.QRect(80, 490, 31, 31))
...
"")
        ...
        self.pushButton_Paciente.setGeometry(QtCore.QRect(480, 730, 121, 28))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
...
"padding-bottom:0.10px;\n"
"")
        self.pushButton_servidor.setObjectName("pushButton__servidor")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_text_login_2.setText(_translate("Form", "Bem-Vindo"))

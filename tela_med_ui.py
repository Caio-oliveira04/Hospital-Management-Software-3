...
"color: rgb(255, 255, 255);")
        ...
        self.label_txt_resultados = QtWidgets.QLabel(self.widget)
        self.label_txt_resultados.setGeometry(QtCore.QRect(690, 360, 291, 41))
        self.label_txt_resultados.setStyleSheet("background-color: qconicalgradient(cx:0.56, cy:1, angle:0, stop:0 rgba(0, 0, 0, 0), stop:1 rgba(255, 255, 255, 0));")
        self.label_txt_resultados.setObjectName("label_txt_resultados")
        ...
        self.label_txt_resultados.raise_()
    ...
    def retranslateUi(self, Form):
        ...
        self.label_txt_resultados.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Rémedios que o paciente já faz uso:</span></p></body></html>"))

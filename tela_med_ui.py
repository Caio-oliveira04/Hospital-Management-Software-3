...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_text_1.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:8pt; color:#ffffff;\">Digite o remédio ou exame para solicitar </span></p><p><br/></p></body></html>"))
        self.label_text_paciente.setText(_translate("Form", "Selecione um paciente"))
        self.pushButton_consultar.setText(_translate("Form", "Ver prontuário"))
        self.pushButton_prescrever.setText(_translate("Form", "Solicitar exame"))
        self.pushButton_solicitar.setText(_translate("Form", "Solicitar remédio"))
        self.label_prontuario.setText(_translate("Form", "Prontuário"))
        ...
        self.label_text_2.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:8pt; color:#ffffff;\">e clique no seu respectivo botão</span></p><p><br/></p></body></html>"))
        ...
        self.label_txt_remedio.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Remédios que o paciente já faz uso:</span></p></body></html>"))
